 ...
 * used to create a {@link java.sql.ShardingKey} with sub-keys of supported data types.
 ...
 * create a {@link java.sql.ShardingKey}:
 * <pre>
 * {@code
 *
...
public interface ShardingKeyBuilder {
     ...
     */
    java.sql.ShardingKeyBuilder subkey(Object subkey, SQLType subkeyType);
