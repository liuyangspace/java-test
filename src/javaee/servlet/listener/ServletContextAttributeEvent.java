 ...
 */
public class ServletContextAttributeEvent extends javax.servlet.ServletContextAttributeEvent {
    /**
     ...
     */
    public ServletContextAttributeEvent(ServletContext source, String name, Object value) { super(source,name,value); }
