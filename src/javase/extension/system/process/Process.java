...
public abstract class Process extends java.lang.Process{
    ...
    public Stream<java.lang.ProcessHandle> children(){return super.children();}
    public Stream<java.lang.ProcessHandle> descendants(){return super.descendants();}
    ...
    public java.lang.ProcessHandle toHandle(){throw new UnsupportedOperationException(this.getClass() + ".toHandle() not supported");}
    public java.lang.ProcessHandle.Info info(){return super.info();}
